...
V-R21 — row literals now follow the **landed C0 at `8a23b1d`**, drift table in §15)
**Date:** 2026-09-20
...
which node claimed what). **First diagnosis:** a `derived_rule='DegradedRf2'` row whose `ack_nodes`
